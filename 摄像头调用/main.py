...
def chineseText(imge,text,px,py):
    font_size = 30
    py-=font_size
    font_color = (0, 0, 255)
    font_path = 'simhei.ttf' # 字体文件路径
    font = ImageFont.truetype(font_path, font_size)
    pil_img = Image.fromarray(cv2.cvtColor(imge, cv2.COLOR_BGR2RGB))
...
while True:
    ...
    #cv2.putText(image,"zjr",(0,48),cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255))
